...
const SearchPage = () => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row h-screen">
      {/* Sidebar */}
      <aside className="w-full md:w-1/4 h-auto md:h-[96vh] bg-[#274B6D] text-white p-6 shadow-strong-right z-10 rounded-xl mx-auto md:mx-4 my-4 flex flex-col justify-center">
