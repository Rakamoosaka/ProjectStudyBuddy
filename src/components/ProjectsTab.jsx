        ...
        <div className="p-6 w-full flex flex-col items-center">
            ...
            <div className="w-6/12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                    ...
                    <p className="mt-2 font-josefinSans text-[#071D2D] mr-auto text-base text-center">New project</p>
                </div>
                ...
                {projects.map((project, index) => (
                    ...
                    >
                        ...
                        />
                        <p className="mt-2  font-josefinSans text-[#071D2D] mr-auto text-base text-center">{project.title}</p>
                    </div>
                ))}
            </div>
        </div>
