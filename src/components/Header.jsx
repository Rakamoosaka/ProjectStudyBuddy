...
const Header = () => {
  return (
    <header className= "flex items-center justify-between px-4 md:px-16 py-4 bg-[#f6f7ff] font-josefinSans">
      {/* Logo Section */}
      <Link to="/home">
      ...
      <div className="flex items-center space-x-4">
        ...
        <a href="/signin" className="text-[#162850] text-sm md:text-base font-semibold">log in</a>
        <a
          href="/signup"
